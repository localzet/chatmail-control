...
- [src/bans.rs](./src/bans.rs)
- [src/health.rs](./src/health.rs)
- [src/settings.rs](./src/settings.rs)
- [templates](./templates)
- [static/app.css](./static/app.css)
- [systemd/chatmail-control.service](./systemd/chatmail-control.service)
...
After that, the release tarball is attached to the GitHub Release.
...
If you want automatic server deployment, the next step is a separate `deploy.yml` workflow that connects over SSH, installs the latest release bundle, and restarts the systemd service.
